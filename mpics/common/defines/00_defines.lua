NDefines = {
	...
	NGameplay = {
		...
		LEADER_ADMIRAL_FLEET_COMBAT_EXPERIENCE_SCALE				= 0.8, -- Scale factor used when calculating experience gain for Admiral
		LEADER_ADMIRAL_FLEET_COMBAT_SHIPS_KILLED_CONVERSION			= 0.5, -- Scale factor for total number of ships killed after combat when calculating experience gain for Admiral
		...
		LEADER_GENERAL_GROUND_COMBAT_EXPERIENCE_SCALE				= 0.8, -- Scale factor used when calculating experience gain for General
		...
		LEADER_GOVERNOR_BUILDING_OR_TILE_CLEAR_EXPERIENCE			= 1.5, -- Scale-value for each completed building-construction or tile-clear, multiplied with the resources spent
		LEADER_GOVERNOR_EDICT_GAIN_EXPERIENCE						= 0.15, -- Scale-value for the exp-gain given each month an Edict is active on the planet, multiplied with the resources spent
		LEADER_GOVERNOR_POP_IS_BORN_EXPERIENCE						= 32, -- Exp-gain for each Pop born
		...
		GENERAL_DAMAGE_EXP_MULT		= 2.0,				-- Multiplier of how much damage translates into experience.
		GENERAL_DEFENSE_EXP_MULT	= 2.0,				-- Multiplier of how much defense translates into experience.
...
--		ETHOS_UNIFORM						= 25,	-- Uniform ethos results in this opinion value
		...
		TERRAFORM_DEFAULT_DURATION_DAYS		= 360,	-- Default number of days required to successfully terraform a planet
		...
		ANOMALY_SPAWN_CHANCE					= 0.08,-- Percent chance that a planet gets a discovery when surveyed - was 0.025
		...
		TECH_COST_FREE_POPS						= 100, -- First X pops do not add any tech cost
		...
		CORE_SECTOR_PLANET_CAP					= 25,	-- Too many planets in core sector will apply modifier inefficient_planet_management.
		SECTOR_CAP								= 8,	-- Too many sectors will apply modifier inefficient_sector_management.
		...
		SECTOR_REVOKE_PLANET_COST				= 5,	-- Influence cost for revoking a planet from a sector
		DELETE_SECTOR_COST						= 10,	-- Influence cost for deleting a sector
		...
		RESOURCE_CLUSTER_COUNT					= 12, 	-- Number of resource clusters containing special resources
		...
		INTEGRATE_SUBJECT_MIN_DAYS 				= 360, -- Amount of days the subject has been a subject before we can integrate it
		...
		FLEET_COMBAT_DEALT_BIG_HP_DMG			= 10000, -- Amount of hitpoints damage to give achievement_grand_admiral
		...
		NAVY_SIZE_SPACEPORT_BASE							= 10,	-- Base value of Naval Capacity for each spaceport
		NAVY_SIZE_SPACEPORT_MULT							= 2,	-- Mult value of Naval Capacity for each spaceport level ( NAVY_SIZE_BASE + Level * NAVY_SIZE_MULT )
	...
	NEconomy = {
		...
		FLEET_UPGRADE_TIME_COST_MULT		= 0.05,		-- Upgrade fleet cost
		...
		FLEET_UPGRADE_MINERAL_COST_MULT		= 0.25,		
