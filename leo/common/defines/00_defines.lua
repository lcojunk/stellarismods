NDefines = {
	...
	NGameplay = {
		...
		LEADER_POOL_SIZE		= 9,				-- leo was 3Each leader pool will consist of this many leaders
...
--		ETHOS_UNIFORM						= 25,	-- Uniform ethos results in this opinion value
		...
		ANOMALY_SPAWN_CHANCE					= 0.08, -- leo was 0.025 Percent chance that a planet gets a discovery when surveyed - was 0.025
		...
		CORE_SECTOR_PLANET_CAP					= 25,	--  leo was 5 Too many planets in core sector will apply modifier inefficient_planet_management.
		...
		SECTOR_REVOKE_PLANET_COST				= 5,	-- leo was 25 Influence cost for revoking a planet from a sector
		...
		FLEET_COMBAT_DEALT_BIG_HP_DMG			= 10000, -- leo was 100000 Amount of hitpoints damage to give achievement_grand_admiral
		...
		NAVY_SIZE_SPACEPORT_MULT							= 2,	-- leo was 1 Mult value of Naval Capacity for each spaceport level ( NAVY_SIZE_BASE + Level * NAVY_SIZE_MULT )
	...
	NEconomy = {
		...
		FLEET_UPGRADE_MINERAL_COST_MULT		= 0.25,		--  leo was 0.75
