...
NDefines = {
	...
	NGameplay = {
		ALLOW_EMPIRE_DESIGN_CHEATS = true, -- leo was false
		...
		LEADER_POOL_SIZE		= 9,				-- leo was 3 Each leader pool will consist of this many leaders
		LEADER_POOL_LEAD_TIME	= 10,				-- Years leaders will remain in the leader pool until replaced
		LEADER_HIRING_COST 		= 50,
		LEADER_BASE_CAP			= 50, -- leo was 10
		...
		LEADER_AGE_MIN			= 18,				-- leo was 28 Min age of generated leaders
		LEADER_AGE_MAX			= 40,				-- leo was 50 Max age of generated leaders
		...
		LEADER_ADMIRAL_FLEET_COMBAT_EXPERIENCE_SCALE				= 0.8, -- leo was 0.4 Scale factor used when calculating experience gain for Admiral
		LEADER_ADMIRAL_FLEET_COMBAT_SHIPS_KILLED_CONVERSION			= 0.5, -- leo was 0.25 Scale factor for total number of ships killed after combat when calculating experience gain for Admiral
		...
		LEADER_GENERAL_GROUND_COMBAT_EXPERIENCE_SCALE				= 0.8, -- leo was 0.4 Scale factor used when calculating experience gain for General
		LEADER_GENERAL_GROUND_COMBAT_ARMIES_KILLED_CONVERSION		= 0.5, -- leo was 0.25 Scale factor for total number of armies killed after combat when calculating experience gain for General
		...
		LEADER_GOVERNOR_BUILDING_OR_TILE_CLEAR_EXPERIENCE			= 1.5, -- leo was 0.5 Scale-value for each completed building-construction or tile-clear, multiplied with the resources spent
		LEADER_GOVERNOR_EDICT_GAIN_EXPERIENCE						= 0.15, -- leo was 0.05 Scale-value for the exp-gain given each month an Edict is active on the planet, multiplied with the resources spent
		LEADER_GOVERNOR_POP_IS_BORN_EXPERIENCE						= 32, -- leo was 8 Exp-gain for each Pop born
		...
		GENERAL_DAMAGE_EXP_MULT		= 2.0,				-- leo was 1.0 Multiplier of how much damage translates into experience.
		GENERAL_DEFENSE_EXP_MULT	= 2.0,				-- leo was 1.0 Multiplier of how much defense translates into experience.
		...
		HABITABILITY_OPPOSITE_PLANET	= 0.40,			-- At which point we color habitability icons and text red
		...
		TERRAFORM_DEFAULT_DURATION_DAYS		= 360,	--  leo was 3600 Default number of days required to successfully terraform a planet
		...
		DEFENSIVE_PACT_INFLUENCE_COST  		= 0,	-- leo was 1 Per defensive pact
		GUARANTEE_INFLUENCE_COST  			= 0,	-- leo was 1 Per guarantee
		ALLIANCE_INFLUENCE_COST  			= 0,	-- leo was 1 For being in an alliance
		FEDERATION_INFLUENCE_COST  			= 0,	-- leo was 2 For being in a federation
		...
		SPACEPORT_LEVELS 						= 10,	-- leo was 6 Number of spaceport levels
		...
		ANOMALY_SPAWN_CHANCE					= 0.08, -- leo was 0.025 Percent chance that a planet gets a discovery when surveyed
		...
		TECH_COST_MULT_NUM_COLONIES				= 0.0, -- leo was 0.1 Each Planet adds +X% tech cost
		TECH_COST_FREE_POPS						= 100, -- leo was 10 First X pops do not add any tech cost
		TECH_COST_MULT_NUM_POPS					= 0.00, -- leo was 0.01 Each non-free Pop adds +X% tech cost
		...
		CORE_SECTOR_SYSTEM_CAP					= 25,	-- leo was 5 Too many systems with owned planets in core sector will apply modifier inefficient_planet_management.
		SECTOR_CAP								= 8,	-- leo was 2 Too many sectors will apply modifier inefficient_sector_management.
		...
		SECTOR_REVOKE_SYSTEM_COST				= 5,	-- leo was 25 Influence cost for revoking a system from a sector
		DELETE_SECTOR_COST						= 10,	-- leo was 100 Influence cost for deleting a sector
		...
		RESOURCE_CLUSTER_COUNT					= 12, 	-- leo was 6 Number of resource clusters containing special resources
		...
		INTEGRATE_SUBJECT_MIN_DAYS 				= 360, -- leo was 3600 Amount of days the subject has been a subject before we can integrate it
		SUBJECTS_INTEGRATION_CAP				= 2, -- leo was 1 Amount of integrations you're allowed to have at the same time
		...
		NAVY_SIZE_SPACEPORT_BASE							= 10,	--  leo was 5  Base value of Naval Capacity for each spaceport
		NAVY_SIZE_SPACEPORT_MULT							= 2,	-- leo was 2  Mult value of Naval Capacity for each spaceport level ( NAVY_SIZE_BASE + Level * NAVY_SIZE_MULT )
	...
	NShip = {
		...
		MILITARY_POWER_SPACEPORT_MULT		= 0.5,
	...
	NPop = {
		...
		BASE_HAPPINESS					= 0.60,  -- leo was 0.5 Base value of pop happiness
	...
	NEconomy = {
		...
		FLEET_UPGRADE_TIME_COST_MULT		= 0.05,		-- leo was 0.25 Upgrade fleet cost
		...
		FLEET_UPGRADE_MINERAL_COST_MULT		= 0.25,		-- leo was 0.75 mineral cost of ship upgrade is abs( price difference between old and new designs * FLEET_UPGRADE_MINERAL_COST_MULT )
		...
		OUTPOST_STATION_MINERAL_COST		= 100,		-- leo was 200 Mineral cost to build outpost
		...
		OUTPOST_STATION_INFLUENCE_MAINTENANCE = 0.5,	-- leo was 1.0 Monthly outpost station Influence maintenance
	...
	NAI = {
		...
		ALLIANCE_ACCEPTANCE_ATTITUDE_COEXIST = 0, 
		ALLIANCE_ACCEPTANCE_OTHER_ATTITUDE = -50,
		ALLIANCE_ACCEPTANCE_SHARED_RIVAL = 10, -- per rival
		ALLIANCE_ACCEPTANCE_SHARED_RIVAL_IN_ALLIANCE = 5, -- extra per rival in alliance
		ALLIANCE_ACCEPTANCE_SHARED_THREAT = 0.5,	-- scales with actual threat
		ALLIANCE_CONQUEROR_DIFFERENCE = -100,	-- penalty if one side wants to wage wars of conquest and the other doesn't
		...
		ALLIANCE_ACCEPTANCE_MEMBER_VOTE = 50,	-- added to acceptance when a member is voting whether to approve an alliance invite
		ALLIANCE_ACCEPTANCE_MEMBER_VOTE_SIZE_FACTOR = -5,	-- for each member above two, 
		ALLIANCE_ACCEPTANCE_MEMBER_VOTE_MIN = 20,
		...
		NON_AGGRESSION_PACT_ACCEPTANCE_SHARED_RIVAL = 25, -- per rival
		...
		TRADE_VALUE_RESOURCE_INCOME_BASE = 10,	-- used for calculating resource income effect (lower = more value reduction from higher income)
		TRADE_VALUE_RESOURCE = 1,	-- for minerals and energy (scaled by income & need)
		...
		MAX_MINERALS_STORED_SECTOR_POST = 150,		-- Minerals AI will store for each budget post in sectors	
